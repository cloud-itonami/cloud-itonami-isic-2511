# Operator Quickstart — Manufacture of Structural Metal Products

Shortest path from clone to a verified local dry-run for **ISIC 2511** (`cloud-itonami-isic-2511`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2511.git
cd cloud-itonami-isic-2511
```
...
- Blueprint governor key: `structural-fabrication-governor`
- Likely source path: `structuralsteel.governor.cljc`
