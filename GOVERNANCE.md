...
`cloud-itonami-isic-2511` is an OSS open-business blueprint for structural
metal products manufacturing enablement, robotics-premised.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- a robot action the governor refuses is never dispatched to hardware.
- the Structural Fabrication Governor remains independent of the advisor.
